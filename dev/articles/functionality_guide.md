...
``` fansi
1. nitrate_test_10scans.raw has 10 scans with 307 peaks; + loaded 2 spectra
(618 points)
...
[`orbi_start_aggregator()`](https://isoorbi.isoverse.org/dev/reference/orbi_aggregator.md)
and/or expand an existing one with `orgi_add_to_aggregator()` and then
register it via
[`orbi_register_aggregator()`](https://isoorbi.isoverse.org/dev/reference/orbi_aggregator.md).
...
[`orbi_get_data()`](https://isoorbi.isoverse.org/dev/reference/orbi_get_data.md).
