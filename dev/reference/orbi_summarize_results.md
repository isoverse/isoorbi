...
[`orbi_calculate_summarized_ratio()`](https://isoorbi.isoverse.org/dev/reference/orbi_calculate_summarized_ratio.md)
...
orbi_summarize_results(
  ...
  .by = c("block", "block_name", "segment", "data_group", "data_type", "injection"),
