...
## Using isox files (obsolete)

This is how these files were used to be read. Now wer recommend reading raw files directly (see next section).
...
# Process data (this is the same as with an isox file)
df <- 
  data_all |>
  # check for issues
  # removes minor signals that were reported by IsoX in the same tolerance window where the peak of interest is
